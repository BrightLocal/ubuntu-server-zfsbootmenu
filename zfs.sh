...
##Variables:
ubuntuver="jammy" #Ubuntu release to install. "jammy" (22.04). "noble" (24.04).
...
hostname="mysql-prod-04" #Name to identify the main system on the network. An underscore is DNS non-compliant.
